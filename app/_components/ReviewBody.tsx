...
function BudgetSpent() {
  return (
    <Notice data-budget="spent">
      <strong className="font-semibold">This session has reached its limit.</strong> The meters are frozen on the last
      answers — reload for a fresh session.
    </Notice>
  );
}
