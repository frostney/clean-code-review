  ...
  return (
    ...
    >
      ...
      <div className="mt-1.5 flex flex-wrap items-center gap-x-2 gap-y-1">
        ...
        <p data-generated-by className="w-full text-tiny text-muted/80 lg:ml-auto lg:w-auto lg:text-right">
...
function Body({
  ...
  if (!text) {
    ...
    return <p className="text-[14px] text-muted lg:text-[13px]">{why ? `No review: ${why}` : "No review yet"}</p>;
  }
  return (
    <p
