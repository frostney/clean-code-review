...
fails is retried once. If some of a file still goes unanswered, pressing Retry sends that file again,
and the windows Jev already answered come from the cache rather than being sent to it again. Luna is given its first ${FILE_EXCERPT_CHARS.toLocaleString('en-US')} characters and Jev's
